...
const globalForBotEvents = globalThis as unknown as {
  whatsappBotOutboundKeys?: Map<string, number>
  whatsappSeenEventIds?: Map<string, number>
}
const botOutboundKeys = globalForBotEvents.whatsappBotOutboundKeys ?? new Map<string, number>()
globalForBotEvents.whatsappBotOutboundKeys = botOutboundKeys
...
const seenWaEvents = globalForBotEvents.whatsappSeenEventIds ?? new Map<string, number>()
globalForBotEvents.whatsappSeenEventIds = seenWaEvents

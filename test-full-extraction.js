...
if (!OPENROUTER_API_KEY || !imagePath) {
  console.log('Usage: OPENROUTER_API_KEY=xxx node test-full-extraction.js <image>');
  process.exit(1);
}
...
// This is the FULL extraction prompt currently used in production
...
async function testFullExtraction() {
  console.log('=== Testing FULL extraction (all dates at once) ===\n');
